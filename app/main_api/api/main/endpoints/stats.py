...
from main_api.api.main.serializers import stats_layers_area_input, stats_layers_area, stats_layers_area_nuts_input
...
class StatsLayersInArea(Resource):
    ...
    def post(self):
        ...
        if nuts_layers != None and hasattr(nuts_layers, '__len__') and len(nuts_layers) > 0:
            ...
            nuts = Nuts.nuts_in_geometry(geometry=geom, year=year, nuts_level=max(nuts_levels))
