...
class TestAddUploads(TestCase):
    def test_post_working(self):
        ...
        values = {'token': test_token, 'name': test_upload_name, 'layer_type': "test"}
    ...
    def test_post_missing_parameter(self):
        ...
        """
        files = {'file': open(test_csv_file, 'rb')}
        values = {'dstoken': test_token, 'sdafname': test_upload_name, 'layerdwd_type': "test"}
    ...
    def test_post_user_unidentified(self):
        ...
        """
        files = {'file': open(test_csv_file, 'rb')}
        values = {'token': 'invalidtoken', 'name': test_upload_name, 'layer_type': "test"}
