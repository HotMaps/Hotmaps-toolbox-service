...
POTENTIAL_SOLARTHERMAL_COLLECTORS_ROOFTOP = \
    'potential_solarthermal_collectors_rooftop'
POTENTIAL_SOLARTHERMAL_COLLECTORS_OPEN_FIELD = \
    'potential_solarthermal_collectors_open_field'
...
layersData = {
    HEAT_DENSITY_TOT: {
        ...
        'indicators': [
                ...
                },
            {
                'table_column': 'min',
                'unit': 'MWh/(ha*yr)',
                'indicator_id': 'consumption_min',
                'agg_method': 'min',
                },
            {
                'table_column': 'max',
                'unit': 'MWh/(ha*yr)',
                'indicator_id': 'consumption_max',
                'agg_method': 'max',
                },
            {
                'table_column': 'mean',
                ...
                'agg_method': 'mean_weighted_cells',
                },
            {
                ...
                'unit': 'MWh/(person*yr)',
                'indicator_id': HEAT_DENSITY_TOT + '_per_'
                    + POPULATION_TOT,
                'agg_method': 'sum',
                },
            ],
    ...
    HEAT_DENSITY_RES: {
        ...
        'indicators': [{
            ...
            'reference_tablename_indicator_id_2': POPULATION_TOT,
            'unit': 'MWh/(person*yr)',
            'indicator_id': HEAT_DENSITY_RES + '_per_'
                + POPULATION_TOT,
            'agg_method': 'sum',
            }],
        },
    HEAT_DENSITY_NON_RES: {
        ...
        'indicators': [{
            ...
            'reference_tablename_indicator_id_2': POPULATION_TOT,
            'unit': 'MWh/(person*yr)',
            'indicator_id': HEAT_DENSITY_NON_RES + '_per_'
                + POPULATION_TOT,
            'agg_method': 'sum',
            }],
        },
    COOL_DENSITY_TOT: {
        'tablename': COOL_DENSITY_TOT,
        ...
        'indicators': [
                ...
                },
            {
                ...
                'reference_tablename_indicator_id_2': POPULATION_TOT,
                'unit': 'MWh/(person*yr)',
                'indicator_id': COOL_DENSITY_TOT + '_per_'
                    + POPULATION_TOT,
                'agg_method': 'sum',
                },
            ],
    ...
    GRASS_FLOOR_AREA_TOT: {
        ...
        'indicators': [{
            ...
            'reference_tablename_indicator_id_2': POPULATION_TOT,
            'unit': u'm²/person',
            'indicator_id': GRASS_FLOOR_AREA_TOT + '_per_'
                + POPULATION_TOT,
            'agg_method': 'sum',
            }],
        },
    GRASS_FLOOR_AREA_RES: {
        ...
        'indicators': [{
            ...
            'reference_tablename_indicator_id_2': POPULATION_TOT,
            'unit': u'm²/person',
            'indicator_id': GRASS_FLOOR_AREA_RES + '_per_'
                + POPULATION_TOT,
            'agg_method': 'sum',
            }],
        },
    GRASS_FLOOR_AREA_NON_RES: {
        ...
        'indicators': [{
            ...
            'reference_tablename_indicator_id_2': POPULATION_TOT,
            'unit': u'm²/person',
            'indicator_id': GRASS_FLOOR_AREA_NON_RES + '_per_'
                + POPULATION_TOT,
            'agg_method': 'sum',
            }],
        },
    SHARE_GFA_CONSTRUCTIONS_1975: {
        'tablename': SHARE_GFA_CONSTRUCTIONS_1975,
        'schema_scalelvl': stat_schema,
        'schema_hectare': geo_schema,
        'geo_column': geometry_column,
        'crs': '3035',
    ...
    SHARE_GFA_CONSTRUCTIONS_1990: {
        'tablename': SHARE_GFA_CONSTRUCTIONS_1990,
        'schema_scalelvl': stat_schema,
        'schema_hectare': geo_schema,
        'geo_column': geometry_column,
        'crs': '3035',
    ...
    SHARE_GFA_CONSTRUCTIONS_2000: {
        'tablename': SHARE_GFA_CONSTRUCTIONS_2000,
        'schema_scalelvl': stat_schema,
        'schema_hectare': geo_schema,
        'geo_column': geometry_column,
        'crs': '3035',
    ...
    SHARE_GFA_CONSTRUCTIONS_2014: {
        'tablename': SHARE_GFA_CONSTRUCTIONS_2014,
        'schema_scalelvl': stat_schema,
        'schema_hectare': geo_schema,
        'geo_column': geometry_column,
        'crs': '3035',
    ...
    BUILDING_VOLUMES_TOT: {
        ...
        'indicators': [{
            ...
            'reference_tablename_indicator_id_2': POPULATION_TOT,
            'unit': u'm³/person',
            'indicator_id': BUILDING_VOLUMES_TOT + '_per_'
                + POPULATION_TOT,
            'agg_method': 'sum',
            }],
        },
    BUILDING_VOLUMES_RES: {
        ...
        'indicators': [{
            ...
            'reference_tablename_indicator_id_2': POPULATION_TOT,
            'unit': u'm³/person',
            'indicator_id': BUILDING_VOLUMES_RES + '_per_'
                + POPULATION_TOT,
            'agg_method': 'sum',
            }],
        },
    BUILDING_VOLUMES_NON_RES: {
        ...
        'indicators': [{
            ...
            'reference_tablename_indicator_id_2': POPULATION_TOT,
            'unit': u'm³/person',
            'indicator_id': BUILDING_VOLUMES_NON_RES + '_per_'
                + POPULATION_TOT,
            'agg_method': 'sum',
            }],
        },
    INDUSTRIAL_SITES_EMISSIONS: {
        ...
        'indicators': [{'table_column': 'emissions_ets_2014',
                       'unit': 't/yr', 'indicator_id': 'value'}],
        },
    INDUSTRIAL_SITES_EXCESS_HEAT: {
        ...
        'data_aggregated': False,
        'indicators': [{'table_column': 'excess_heat_100_200c',
                       'unit': 'GWh/yr', 'indicator_id': 'value1'},
                       {'table_column': 'excess_heat_200_500c',
                       'unit': 'GWh/yr', 'indicator_id': 'value2'},
                       {'table_column': 'excess_heat_500c',
                       'unit': 'GWh/yr', 'indicator_id': 'value3'},
                       {'table_column': 'excess_heat_total',
                       'unit': 'GWh/yr', 'indicator_id': 'total'}],
        },
    POPULATION_TOT: {
    ...
    WWTP: {
        ...
        'data_aggregated': False,
        'indicators': [{'table_column': 'capacity', 'unit': 'kW',
                       'indicator_id': 'power'},
                       {'table_column': 'power',
    ...
    WWTP_CAPACITY: {
        ...
        'data_aggregated': False,
        'indicators': [{'table_column': 'capacity',
                       'unit': 'Person equivalent',
                       'indicator_id': 'capacity'}],
        },
    WWTP_POWER: {
        ...
        'data_aggregated': False,
        'indicators': [{'table_column': 'power', 'unit': 'kW',
                       'indicator_id': 'power'}],
        },
    LIVESTOCK_EFFLUENTS: {
    ...
    POTENTIAL_SOLARTHERMAL_COLLECTORS_ROOFTOP: {
        'tablename': POTENTIAL_SOLARTHERMAL_COLLECTORS_ROOFTOP,
        'from_indicator_name': stat \
            + POTENTIAL_SOLARTHERMAL_COLLECTORS_ROOFTOP,
        'schema_scalelvl': stat_schema,
        'schema_hectare': geo_schema,
        'geo_column': geometry_column,
    ...
    POTENTIAL_SOLARTHERMAL_COLLECTORS_OPEN_FIELD: {
        'tablename': POTENTIAL_SOLARTHERMAL_COLLECTORS_OPEN_FIELD,
        'from_indicator_name': stat \
            + POTENTIAL_SOLARTHERMAL_COLLECTORS_OPEN_FIELD,
        'schema_scalelvl': stat_schema,
        'schema_hectare': geo_schema,
    ...
    LAND_SURFACE_TEMP: {
        ...
        'indicators': [{
            ...
            'table_column': 'max',
            'unit': u'°C',
            'indicator_id': 'maximum',
            'factor': 0.1,
            'agg_method': 'max',
            }, {
            'table_column': 'min',
            'unit': u'°C',
            'indicator_id': 'minimum',
            'factor': 0.1,
            'agg_method': 'min',
            }, {
            'table_column': 'count',
