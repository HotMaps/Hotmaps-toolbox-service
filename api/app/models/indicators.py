...
layersData = {
    ...
    COOL_DENSITY_TOT:{'tablename':COOL_DENSITY_TOT,
            ...
            'indicators':[
                ...
                {
                    'reference_indicator_id_1': 'consumption',
                    'reference_tablename_indicator_id_1':COOL_DENSITY_TOT,
                    'operator': '/',
                    'reference_indicator_id_2':'population',
                    'reference_tablename_indicator_id_2':POPULATION_TOT,
                    'unit':'MWh/(person*yr)',
                    'indicator_id':COOL_DENSITY_TOT+'_per_'+POPULATION_TOT,
                    'agg_method':'sum'
                },
            ]
        },
    ...
    GEOTHERMAL_POTENTIAL_HEAT_COND:{'tablename':GEOTHERMAL_POTENTIAL_HEAT_COND,
            ...
            'data_aggregated':False,
            'indicators':[
                {'table_column': 'heat_cond', 'unit': 'W/mK','indicator_id':'value', 'agg_method':'mean'}
            ]
        },
